...
static  const int8_t DIRECT_LUT[] = {
...
static  const struct Range LUT_NONPRINTABLE[] = {
    {0x00d800,0x00dfff},
};

static  const struct Range LUT_2[] = {
...
static  const struct Range LUT_0[] = {
...
static  const struct RangeLut RANGE_LUT_LIST[] = {
...
unicode_to_cell_konsole(unicode_val_T ucs4)
{
	...
	for (rl = RANGE_LUT_LIST; rl->lut != NULL; ++rl) {
		int l = 0;
		int r = rl->size - 1;
