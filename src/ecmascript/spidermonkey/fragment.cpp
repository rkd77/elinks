...
////	JS_PSG("attributes",	fragment_get_property_attributes, JSPROP_ENUMERATE),
////	JS_PSGS("checked",	fragment_get_property_checked, fragment_set_property_checked, JSPROP_ENUMERATE),
...
////	JS_PSG("classList",	fragment_get_property_classList, JSPROP_ENUMERATE),
////	JS_PSGS("className",	fragment_get_property_className, fragment_set_property_className, JSPROP_ENUMERATE),
//	JS_PSG("clientHeight",	fragment_get_property_clientHeight, JSPROP_ENUMERATE),
//	JS_PSG("clientLeft",	fragment_get_property_clientLeft, JSPROP_ENUMERATE),
//	JS_PSG("clientTop",	fragment_get_property_clientTop, JSPROP_ENUMERATE),
//	JS_PSG("clientWidth",	fragment_get_property_clientWidth, JSPROP_ENUMERATE),
////	JS_PSG("dataset",	fragment_get_property_dataset, JSPROP_ENUMERATE),
////	JS_PSGS("dir",	fragment_get_property_dir, fragment_set_property_dir, JSPROP_ENUMERATE),
...
////	JS_PSGS("href",	fragment_get_property_href, fragment_set_property_href, JSPROP_ENUMERATE),
	JS_PSGS("id",	fragment_get_property_id, fragment_set_property_id, JSPROP_ENUMERATE),
////	JS_PSGS("innerHTML",	fragment_get_property_innerHtml, fragment_set_property_innerHtml, JSPROP_ENUMERATE),
////	JS_PSGS("innerText",	fragment_get_property_innerHtml, fragment_set_property_innerText, JSPROP_ENUMERATE),
////	JS_PSGS("lang",	fragment_get_property_lang, fragment_set_property_lang, JSPROP_ENUMERATE),
...
////	JS_PSG("nextElementSibling",	fragment_get_property_nextElementSibling, JSPROP_ENUMERATE),
...
//	JS_PSG("offsetHeight",	fragment_get_property_offsetHeight, JSPROP_ENUMERATE),
//	JS_PSG("offsetLeft",	fragment_get_property_offsetLeft, JSPROP_ENUMERATE),
////	JS_PSG("offsetParent",	fragment_get_property_offsetParent, JSPROP_ENUMERATE),
//	JS_PSG("offsetTop",	fragment_get_property_offsetTop, JSPROP_ENUMERATE),
//	JS_PSG("offsetWidth",	fragment_get_property_offsetWidth, JSPROP_ENUMERATE),
////	JS_PSGS("outerHTML",	fragment_get_property_outerHtml, fragment_set_property_outerHtml, JSPROP_ENUMERATE),
...
////	JS_PSG("style",		fragment_get_property_style, JSPROP_ENUMERATE),
////	JS_PSG("tagName",	fragment_get_property_tagName, JSPROP_ENUMERATE),
	JS_PSGS("textContent",	fragment_get_property_textContent, fragment_set_property_textContent, JSPROP_ENUMERATE),
////	JS_PSGS("title",	fragment_get_property_title, fragment_set_property_title, JSPROP_ENUMERATE),
////	JS_PSGS("value",	fragment_get_property_value, fragment_set_property_value, JSPROP_ENUMERATE),
	JS_PS_END
};
...
static bool
fragment_get_property_clientHeight(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
	...
	struct node_rect *rect = get_fragment_rect(document, offset);
...
#if 0
static bool
fragment_get_property_clientLeft(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
...
#if 0
static bool
fragment_get_property_clientTop(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
...
#if 0
static bool
fragment_get_property_clientWidth(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
...
#if 0
static bool
fragment_get_property_offsetHeight(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
	return fragment_get_property_clientHeight(ctx, argc, vp);
}
#endif

#if 0
static bool
fragment_get_property_offsetLeft(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
	...
	struct node_rect *rect_parent = get_fragment_rect(document, offset_parent);
...
#if 0
static bool
fragment_get_property_offsetTop(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
...
#if 0
static bool
fragment_get_property_offsetWidth(JSContext *ctx, unsigned int argc, JS::Value *vp)
{
#ifdef ECMASCRIPT_DEBUG
	fprintf(stderr, "%s:%s\n", __FILE__, __FUNCTION__);
#endif
	return fragment_get_property_clientWidth(ctx, argc, vp);
}
#endif
